...
export const SchemaChange = z.object({
  ...
  sales_id: z.number().positive().optional(),
});

export type ChangeManagerCreate = z.infer<typeof SchemaChange>;

export default function validatedChangeManager(body: ChangeManagerCreate) {
  try {
